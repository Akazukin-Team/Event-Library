...
[![Build Status](https://github.com/Akazukin-Team/Event-Library/actions/workflows/build.yml/badge.svg?branch=main)](https://github.com/Akazukin-Team/Event-Library/actions/workflows/build.yml?query=branch:main)

Provide Event Manager and Event Listener features.
...
- Provide Event Manager and Event Listener
...
2. Add the dependency to the `dependencies` block in your `build.gradle` file:
    ```groovy
    implementation 'org.akazukin:event:<VERSION>'
    ```
...
1. Clone the repository:
    ```shell
    git clone https://github.com/Akazukin-Team/Event-Library.git
    cd Event-Library
    ```
